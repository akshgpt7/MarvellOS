...
def welcome(o=""):
    ...
    confirmbtn = Button(welcome_screen, text="Confirm", bg="cyan", fg="black", font=("Arial black", 9), command=confirm,
                        width=20, height=2)  # confirm button
    ...
    global clock
    clock = Label(welcome_screen, font=("TIMES NEW ROMAN", 10), anchor="e", bg='black', fg="white", width=46,
                  height=2)  # clock label
    clock.place(x=0, y=0)
    if truth:
        try:
            tick()
...
class Home():
    ...
    def __init__(self, a=""):
        ...
        self.clock = Label(home, font=("TIMES NEW ROMAN", 10), anchor="e", bg='black', fg="white", width=46,
                           height=2)  # clock label
        ...
        if self.a == "y":
            ...
            pass
        """App buttons"""
        sett = Button(home, text="Settings", height=5, bg="sky blue", fg="brown", width=10, font=("Bahnschrift", 12),
                      command=self.settings)  # settings button
        sett.place(x=2, y=100)
        calcbtn = Button(home, text="Calculator", height=5, width=10, bg="grey", fg="black", font=("Bahnschrift", 12),
                         command=self.calc)  # calculator button
        calcbtn.place(x=112, y=100)
        design = Button(home, text="Designs", height=5, width=10, bg="purple", fg="cyan", font=("Bahnschrift", 12),
                        command=self.design)  # design button
        design.place(x=222, y=100)
        notepad = Button(home, text="Notepad", height=5, width=10, bg="orange", fg="black", font=("Bahnschrift", 12),
                         command=self.notepad)  # notepad button
        notepad.place(x=2, y=250)
        click = Button(home, text="Click \n Game", height=5, width=10, bg="blue", fg="pink", font=("Bahnschrift", 12),
                       command=self.click_game)  # click test button
        click.place(x=112, y=250)
        sample = Button(home, text="Sample \n Pictures", height=5, width=10, bg="red", fg="yellow",
                        font=("Bahnschrift", 12), command=self.sample)  # sample pictures button
    ...
    def settings(self):
        ...
        home.after_cancel(Home.AFTER)
        home.destroy()
        self.ss = Label(self.setwin, text="Choose a setting:", bg="black", fg="white", width=46, height=2,
                        font=("Arial", 15))
        self.ss.place(x=-90, y=0)
        self.changingbtn = Button(self.setwin, text="Change Password", height=1, bg="sky blue", fg="brown", width=25,
                                  font=("Bahnschrift", 12), command=self.change_password)
    ...
    def sample(self):
        ...
        self.bck = Button(self.samwin, text="<", bg="yellow", font=("Bauhaus 93", 20), command=self.bckfun,
                          state=DISABLED)
    ...
    def design(self):
        ...
        self.homebtn.place(x=140, y=370)
        self.choo = Label(self.deswin, text="Choose a design:", bg="black", fg="white", width=28, height=2,
                          font=("Candara", 15))
